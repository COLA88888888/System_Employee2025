    ...
    <div class="col-lg-6">
        <div class="card">
          <div class="card-header pb-0 d-flex justify-between align-items-center">
            ...
            <button type="button" class="btn rounded-pill btn-icon btn-primary" @click="AddDepartment()" v-if="$can('settings.edit')">
            ...
            <!-- {{DepartmentData}} -->
              <div class="list-group list-group-flush">
                <div v-for="items in DepartmentData" :key="items.id" class="list-group-item list-group-item-action d-flex justify-content-between">
                  ...
                  <span v-if="$can('settings.edit')"><i class='bx bxs-edit cursor-pointer text-warning' @click="EditDepartment(items.id)"></i> | <i class='bx bx-trash cursor-pointer text-danger' @click="DeleteDepartment(items.id)"></i></span>
                </div>
              </div>
          </div>
        </div>
